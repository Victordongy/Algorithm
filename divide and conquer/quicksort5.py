...
if __name__ == '__main__':
    sorters = (QuickSorterFirstElementPivot("week3/QuickSort.txt"),
               QuickSorterLastElementPivot("week3/QuickSort.txt"),
               QuickSorterMedianElementPivot("week3/QuickSort.txt"))
