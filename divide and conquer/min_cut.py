...
class kargermincutter:
    def __init__(self,graph_file):
        self._graph = {}
        self._total_edges = 0
        # output file as a dictionary, key is vertex, value is other adjacent vertex
    ...
    def _pick_random_edge(self):
        ...
        for vertex, vertex_edges in self._graph.items(): ## items return key and value
...
if __name__ == "__main__":
    ...
    for i in range(40000):
        min_cutter = kargermincutter('week4/kargerMinCut.txt')
